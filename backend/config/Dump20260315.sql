...
CREATE TABLE `backup_prescricoes_acompanhante_20260316` (
  ...
  `tipo_acompanhante` enum('adulto','crianca','idoso') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `dietas` (
  ...
  `alias_faturamento` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `descricao` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `ativa` tinyint(1) DEFAULT '1',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `faturamento_itens` (
  ...
  `paciente_nome` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `paciente_cpf` varchar(14) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `nucleo` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `leito` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tipo_item` enum('refeicao_paciente','acrescimo','lactario','acompanhante') COLLATE utf8mb4_unicode_ci NOT NULL,
  `tipo_refeicao` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dieta_original` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `chave_dieta` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `referencia_id` int DEFAULT NULL,
  `referencia_nome` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `quantidade` decimal(10,2) NOT NULL DEFAULT '1.00',
  `valor_unitario` decimal(12,4) NOT NULL DEFAULT '0.0000',
  `valor_total` decimal(12,4) NOT NULL DEFAULT '0.0000',
  `status` enum('cobrado','pendente_preco','cancelado') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'cobrado',
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Armazena todas as prescrições de alimentação dos pacientes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tabela_precos_refeicao` (
  `id` int NOT NULL AUTO_INCREMENT,
  `categoria` enum('paciente','acompanhante') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'paciente',
  `chave_dieta` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dump completed on 2026-03-15 21:30:14
