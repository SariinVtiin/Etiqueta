...
function GestaoUsuarios() {
  ...
  const handleResetarSenha = async (e) => {
    ...
    try {
      const resposta = await resetarSenhaUsuario(
    ...
    <div className="gu-page">
      ...
      <div className="gu-toolbar">
        <div className="gu-search">
          ...
          />
          <button className="gu-btn-search" onClick={handleBuscar}>
            Buscar
          </button>
        </div>
      </div>
          ...
          <table className="gu-table">
            ...
            <tbody>
              {usuarios.map((usuario) => (
                <tr
                  key={usuario.id}
                  className={!usuario.ativo ? "gu-row-inactive" : ""}
                >
                  <td>
                  ...
                  <td>
                    <span className="gu-email">{usuario.email}</span>
                  </td>
                  <td>
                  ...
                  <td>
                    <span
                      className={`gu-badge-status ${usuario.ativo ? "gu-status-ativo" : "gu-status-inativo"}`}
                    >
                  ...
                  <td>
                    <div className="gu-actions">
                      <button
                        className="gu-btn-action gu-btn-edit"
                      ...
                      <button
                        className="gu-btn-action gu-btn-password"
                      ...
                      {usuario.ativo ? (
                        <button
                          className="gu-btn-action gu-btn-deactivate"
                        ...
                        <button
                          className="gu-btn-action gu-btn-activate"
            ...
            <form onSubmit={handleCriarUsuario}>
              ...
              <div className="gu-form-group">
                ...
                <div className="gu-role-selector">
                  <label
                    className={`gu-role-option ${formData.role === "nutricionista" ? "selected" : ""}`}
                  >
                    <input
                      type="radio"
                      name="role"
                  ...
                  <label
                    className={`gu-role-option ${formData.role === "admin" ? "selected" : ""}`}
                  >
                    <input
                      type="radio"
                      name="role"
