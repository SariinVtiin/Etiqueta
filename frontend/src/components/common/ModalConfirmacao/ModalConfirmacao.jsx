...
function ModalConfirmacao({ dados, onConfirmar, onCancelar }) {
  ...
  const getTipoAcompanhanteLabel = () => {
    return dados.tipoAcompanhanteNome || dados.tipoAcompanhante || "-";
  };
      ...
      <div className="mc-container">
        ...
        <div className="mc-header">
          ...
          <p className="mc-header-sub">
            Revise todas as informações abaixo com atenção
          </p>
        </div>
          ...
          <div className="mc-secao">
            ...
            <div className="mc-refeicoes-lista">
              {dados.refeicoes?.map((ref, index) => (
                <div
                  key={index}
                  className={`mc-refeicao-card ${ref.isEspecial ? "mc-refeicao-especial" : ""}`}
                >
                  <div className="mc-refeicao-header">
                    ...
                    {ref.isEspecial && (
                      <span className="mc-tag-especial">
                        Lista Personalizada
                      </span>
                    )}
                  </div>
                    ...
                    {ref.isEspecial ? (
                      ...
                      <>
                        <div className="mc-detalhe-linha">
                          ...
                          <span className="mc-detalhe-valor mc-detalhe-destaque">
                            {ref.dieta}
                          </span>
                        </div>
                          ...
                          <div className="mc-detalhe-linha">
                            ...
                            <span className="mc-detalhe-valor">
                              {ref.restricoes.map((r, i) => (
                                <span key={i} className="mc-tag-restricao">
                                  {r}
                                </span>
                              ))}
                            </span>
                        ...
                        {ref.semPrincipal && (
                          <div className="mc-detalhe-linha mc-detalhe-alerta">
                            <span className="mc-detalhe-label">
                              Sem Principal
                            </span>
                            <span className="mc-detalhe-valor">
                              {ref.descricaoSemPrincipal || "Sim"}
                            </span>
                          </div>
                        )}
              ...
              <div className="mc-grid">
                    ...
                    {dados.acompanhanteRefeicoes?.length > 0 ? (
                      <span className="mc-tags-inline">
                        {dados.acompanhanteRefeicoes.map((r, i) => (
                          <span key={i} className="mc-tag-refeicao">
                            {r}
                          </span>
                        ))}
                      </span>
                ...
                {dados.acompanhanteRestricoesIds?.length > 0 && (
                  <div className="mc-dado mc-dado-full">
                    ...
                    <span className="mc-valor">
                      {dados.acompanhanteRestricoesIds.length} restrição(ões)
                      selecionada(s)
                    </span>
                  </div>
                )}
